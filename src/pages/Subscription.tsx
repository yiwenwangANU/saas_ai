...
const Subscription = () => {
  return (
    <div>
      <div className="flex flex-col gap-4 items-center mx-20 rounded-xl py-10 my-10">
        ...
        <div className="flex flex-row gap-10 items-center px-10">
          <div className="border-2 border-gray-200 rounded-3xl shadow-xl flex flex-col gap-10 px-14 pt-7 pb-10">
